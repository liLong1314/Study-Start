      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">修改二级类目信息</td>
                </tr>
            </table></td>
          </tr>
      </table></td>
      ...
      <td align="center" bgcolor="#FFFFFF"><br>
          ...
          <tr>
            <td height="112">
          	...
          	<html:form action="/arm/EntryModify.do?flag=2" method="post" onsubmit="return doSubmit(this.form);">
                <tr bgcolor="#FFFFFF">
                ...
                <tr bgcolor="#FFFFFF">
                  ...
                  <td>
                  <html:select name="entryForm" property="entryInfo.isOperation" disabled="true">
                  <html:option value="0">文书类</html:option>
                  <html:option value="1">业务类</html:option>
                  <html:option value="2">其它</html:option>
                  </html:select>
                  </td>
                </tr>
                <tr bgcolor="#FFFFFF">
