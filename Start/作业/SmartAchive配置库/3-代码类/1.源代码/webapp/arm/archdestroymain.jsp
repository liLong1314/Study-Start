...
<body class="bg-page01">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="653" align="left" bgcolor="#FFFFFF"> 您现在的位置：销毁管理</td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"> <br> <table width="100%" height="37" border="1">
		...
		<html:form action="/arm/ArchSearch.do?flag=3" method="post">
                <tr bgcolor="#FFFFFF">
      ...
      <td align="center" bgcolor="#FFFFFF" valign="top">
        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF">
          ...
          <tr align="center">
           ...
           <td bgcolor="#f6f6f6" ><a href="/aum/viewArchives.do?flag=3&ARCHIVES_ID=<bean:write name="archOper" property="archivesId"/>"><bean:write name="archOper" property="archivesName"/></a></td>
            ...
            <td bgcolor="#f6f6f6"><a href="/arm/FileView.do?flag=3&archiveId=<bean:write name="archOper" property="archivesId"/>">查看卷内文件</a></td>
          </tr>
          </logic:iterate>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <input name="Submit" type="button" onclick="window.location='/arm/FileDestroyStat.do'"value="销毁统计">
            </td>
          </tr>
        </table>
      </td>
