...
<body class="bg-page01">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="653" align="left" bgcolor="#FFFFFF"> 您现在的位置：变更管理</td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td background="../image/2_table_c_r.gif">&nbsp;</td>
      <td align="center" bgcolor="#FFFFFF"><table width="100%" height="37" border="1">
          <tr>
            <td height="31">
              <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
		<html:form action="/arm/ArchSearch.do?flag=4" method="post">
                <tr bgcolor="#FFFFFF">
      ...
      <td align="center" bgcolor="#FFFFFF" valign="top">
        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF">
          ...
          <tr align="center">
            ...
            <td bgcolor="#f6f6f6" ><a href="/aum/viewArchives.do?flag=4&ARCHIVES_ID=<bean:write name="archOper" property="archivesId"/>"><bean:write name="archOper" property="archivesName"/></a></td>
            ...
            <td bgcolor="#f6f6f6">
            <a href="/arm/ArchChangeView.do?flag=1&archiveId=<bean:write name="archOper" property="archivesId"/>">变更</a>
            <a href="/arm/ArchChangeStat.do?archiveId=<bean:write name="archOper" property="archivesId"/>">查看变更记录</a>
            </td>
          </tr>
          </logic:iterate>
