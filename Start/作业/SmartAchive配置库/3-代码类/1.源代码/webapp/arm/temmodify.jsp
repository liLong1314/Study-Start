...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                ...
                <td align="center" bgcolor="#F2F9E6" class="tishi">温湿度信息修改</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
	...
	<html:form action="/arm/TemperatureModify.do" method="post" onsubmit="return doSubmit(this.form);">
          <tr>
            <td height="62"> <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                ...
                <td width="9%" align="right">库房<font color="#FF0000">*</font></td>
                  <td width="15%">
		<html:text name="temperatureForm" property="temperatureInfo.roomCode"/>
		<html:hidden name="temperatureForm" property="temperatureInfo.temperatureId"/>
		</td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  
                <td align="right">温度<font color="#FF0000">*</font></td>
                  <td><html:text name="temperatureForm" property="temperatureInfo.temperatureDegree"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  
                <td align="right">湿度<font color="#FF0000">*</font></td>
                  <td><html:text name="temperatureForm" property="temperatureInfo.temperatureWet"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  
                <td align="right">登记日期(YYYY-MM-DD)</td>
                  <td><html:text name="temperatureForm" property="temperatureInfo.temperatureDate"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">登记人</td>
                  <td><html:text name="temperatureForm" property="temperatureInfo.temperatureMan"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">说明</td>
                  <td><html:textarea name="temperatureForm" property="temperatureInfo.remark"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
