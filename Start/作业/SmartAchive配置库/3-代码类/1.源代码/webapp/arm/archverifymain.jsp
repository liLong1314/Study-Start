...
<body class="bg-page01">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="653" align="left" bgcolor="#FFFFFF"> 您现在的位置：档案校验</td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"> <br> <table width="100%" height="37" border="1">
		...
		<html:form action="/arm/ArchSearch.do?flag=1" method="post">
                <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <html:form action="/arm/ArchBreak.do" method="post">
	...
	<logic:iterate id="archOper" name="ArchOpers">
        <tr align="center">
          <td bgcolor="#f6f6f6" width="15%">
            <input type="checkbox" name="archOperInfo.archlist" value="<bean:write name="archOper" property="archivesId"/>">
          </td>
          <td bgcolor="#f6f6f6" width="15%"><bean:write name="archOper" property="archivesNum"/></td>
          <td bgcolor="#f6f6f6" ><a href="/aum/viewArchives.do?flag=1&ARCHIVES_ID=<bean:write name="archOper" property="archivesId"/>"><bean:write name="archOper" property="archivesName"/></a></td>
          <td bgcolor="#f6f6f6" width="15%"><bean:write name="archOper" property="archivesYear"/></td>
          <td bgcolor="#f6f6f6" width="15%"><bean:write name="archOper" property="storeTerm"/></td>
          <td bgcolor="#f6f6f6" width="20%"><a href="/arm/FileView.do?flag=1&archiveId=<bean:write name="archOper" property="archivesId"/>">查看卷内文件</a></td>
        </tr>
        </logic:iterate>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <input name="Submit5" type="submit" value="拆卷">
            </td>
          </tr>
        </table>
	</html:form>
