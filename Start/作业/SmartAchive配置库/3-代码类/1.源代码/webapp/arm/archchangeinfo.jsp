...
<body class="bg-page01">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="653" align="left" bgcolor="#FFFFFF"> 您现在的位置：<a href="/arm/ArchView.do?flag=4">变更管理</a>&gt;&gt; <a href="/arm/ArchChangeStat.do">档案变更统计</a>&gt;&gt; 查看详细档案信息</td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
              <tr bgcolor="#FFFFFF">
                ...
                <td width="30%"> <bean:write name="ArchOperInfo" property="archivesYear"/>
                </td>
              </tr>
              <tr bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td> <bean:write name="ArchOperInfo" property="archivesNum"/>
                </td>
                <td align="right">说明：</td>
                <td><bean:write name="ArchOperInfo" property="remark"/></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td align="center" colspan="4">
                  <input name="Submit" type="button" value="返回" onclick="javaScript:history.back()">
                </td>
              </tr>
            </table>
            </td>
