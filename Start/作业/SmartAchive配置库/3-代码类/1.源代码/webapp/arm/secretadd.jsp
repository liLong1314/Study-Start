  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">增加密级信息</td>
                </tr>
            </table></td>
          </tr>
      </table></td>
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"><br>
		...
		<html:form action="/arm/SecretAdd.do" method="post" onsubmit="return doSubmit(this.form);">
                <tr bgcolor="#FFFFFF">

                <td width="9%" align="right">密级编号<font color="#FF0000">*</font></td>
                  <td width="15%"><html:text property="secretInfo.secretCode" size="12"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">

                <td align="right">密级名称<font color="#FF0000">*</font></td>
                  <td><html:text property="secretInfo.secretName" size="12"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">说明</td>
                  <td><html:textarea property="secretInfo.remark" /></td>
                </tr>
                <tr bgcolor="#FFFFFF">
