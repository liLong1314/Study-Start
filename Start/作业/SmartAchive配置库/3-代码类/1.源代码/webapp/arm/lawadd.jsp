...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">法律法规登记</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"><br>
		...
		<html:form action="/arm/LawAdd.do" method="post" onsubmit="return doSubmit(this.form);">
                <tr bgcolor="#FFFFFF">
                  
                <td width="9%" align="right">法律法规类型<font color="#FF0000">*</font></td>
                  <td width="15%"><html:text property="lawInfo.lawType"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  
                <td align="right">法律法规编号<font color="#FF0000">*</font></td>
                  <td><html:text property="lawInfo.lawCode"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">发布单位</td>
                  <td><html:text property="lawInfo.lawDept"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  
                <td align="right">发布日期(YYYY-MM-DD)</td>
                  <td><html:text property="lawInfo.lawDate"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  
                <td align="right">法律法规主题<font color="#FF0000">*</font></td>
                  <td><html:text property="lawInfo.lawTitle"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">法律法规内容</td>
                  <td><html:textarea property="lawInfo.lawContent"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">说明</td>
                  <td><html:textarea property="lawInfo.remark"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
