...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="653" align="left" bgcolor="#FFFFFF"> 您现在的位置： &gt;&gt; 档案管理 &gt;&gt;
      档案信息管理 &gt;&gt; <a href="/arm/viewallwatchexamine.do" target="hmain">监督检查管理</a>&gt;&gt;分局目录管理</td>
          ...
          <tr>
            <td height="39"> <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                <tr align="center" bgcolor="#FFFFFF">
                  ...
                  <html:option value="8">上城规划分局</html:option> <html:option value="9">下城规划分局</html:option>
                  <html:option value="11">江干规划分局</html:option> <html:option value="12">拱墅规划分局</html:option>
                  <html:option value="10">西湖规划分局</html:option></html:select>
                </td>
                <td width="15%" rowspan="2">案卷题名 <html:text property="subRollCatalogInfo.rollCataTitle" size="18"/></td>
