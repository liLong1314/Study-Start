...
<body class="bg-page01">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="653" align="left" bgcolor="#FFFFFF"> 您现在的位置：  &gt;&gt; <a href="/arm/StudySearch.do">编研管理</a> &gt;&gt; 修改编研信息</td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">修改编研信息</td>
                </tr>
            </table></td>
          </tr>
      </table></td>
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"><br>
		...
		<html:form action="/arm/StudyModify.do" method="post" onsubmit="return doSubmit(this.form);">
                 <tr bgcolor="#FFFFFF">
                  <td width="9%" align="right">编研类别</td>
                  <td width="15%">
		<html:hidden name="studyForm" property="studyInfo.studyId"/>
