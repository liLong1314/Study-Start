...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                ...
                <td align="center" bgcolor="#F2F9E6" class="tishi">修改安全信息</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"><br>
		...
		<html:form action="/arm/SafetyModify.do" method="post" onsubmit="return doSubmit(this.form);">
                 <tr bgcolor="#FFFFFF">
                  
                <td width="9%" align="right">库房<font color="#FF0000">*</font></td>
                  <td width="15%">
                  <html:text name="safetyForm" property="safetyInfo.roomCode" size="12"/>
                  <html:hidden name="safetyForm" property="safetyInfo.safetyId"/>
                  </td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">安全类型</td>
                  <td>
                  <html:select name="safetyForm" property="safetyInfo.safetyType">
                ...
                <tr bgcolor="#FFFFFF">
                  ...
                  <td><html:text name="safetyForm" property="safetyInfo.safetySituation" size="12"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">检查人</td>
                  <td><html:text name="safetyForm" property="safetyInfo.safetyChecker" size="12"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  
                <td align="right">检查日期(YYYY-MM-DD)</td>
                  <td><html:text name="safetyForm" property="safetyInfo.safetyCheckDate" size="12"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">处理人</td>
                  <td><html:text name="safetyForm" property="safetyInfo.safetyDealWithPerson" size="12"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  
                <td align="right">处理日期(YYYY-MM-DD)</td>
                  <td><html:text name="safetyForm" property="safetyInfo.safetyDealedDate" size="12"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">处理结果</td>
                  <td><html:text name="safetyForm" property="safetyInfo.safetyResult" size="12"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td align="right">说明</td>
                  <td><html:textarea name="safetyForm" property="safetyInfo.remark"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
