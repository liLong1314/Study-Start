...
function mySubmit() {	
	if (!CheckValid())
		return false;
	document.all.functionName.value = "update";
...
<html:hidden property="chargeStandard.charge_id"/>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="620" align="left" bgcolor="#FFFFFF"> 您现在的位置： 收费标准定义 &gt;&gt; 修改收费标准 &gt;&gt; </td>
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">修改收费标准定义信息</td>
                </tr>
            </table></td>
          </tr>
      </table></td>
              ...
              <td height="31">
                <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td width="30%" nowrap><html:text property="chargeStandard.charge_version" style="width:100%" maxlength="4"/></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td >执行开始日期(如:2003-12-31)</td>
                    <td nowrap><html:text property="chargeStandard.charge_begin_date" style="width:100%" maxlength="10"/></td>
                    <td >执行结束日期(如:2003-12-31)</td>
                    <td nowrap><html:text property="chargeStandard.charge_end_date" style="width:100%" maxlength="10"/></td>
                    <td nowrap>收费标准金额</td>
                    <td nowrap><html:text property="chargeStandard.charge_money" style="width:100%" maxlength="10"/></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td nowrap>收费依据</td>
