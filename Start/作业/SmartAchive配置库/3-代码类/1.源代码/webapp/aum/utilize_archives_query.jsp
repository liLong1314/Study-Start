...
<html:form action="/aum/queryArchivesList" method="post" >
  <html:hidden property="archives.AENTRY_ID"/>
  <html:hidden property="archives.AIS_OPERATION"/>
  <html:hidden property="archives.AARCHIVES_STATUS" value=""/>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="100%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#00A8CC">
                <tr>
                  <td align="center" bgcolor="#E4F2FA" class="style1">档案列表</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
	...
	<logic:iterate id="list" name="archivesList" >
        <tr align="center" style='cursor:hand' onMouseover="this.style.backgroundColor='#dff1ff'" onMouseOut="this.style.backgroundColor=''" onclick="doGoto('utilizeArchivesFilesList.do?ARCHIVES_ID=<bean:write name='list' property='AARCHIVES_ID' />')">
