...
<script>
  ...
  function doFilter(filterFlag) {
    window.location.href="/aum/BorrowTaskList.do?flag="+filterFlag;
  }
...
function doCombQuery(form){
  ...
  if(!BASEtrim(applyBeginTime.value)=="" && BASEisNotDate(applyBeginTime.value))
    ...
    window.location.href="/aum/BorrowTaskList.do?queryFlag="+queryFlag+"&deliverBeginTime="+deliverBeginTime.value+"&deliverEndTime="+deliverEndTime.value+"&applyBeginTime="+applyBeginTime.value+"&applyEndTime="+applyEndTime.value+"&utilizer="+utilizer.value;;
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td align="center"    bgcolor="#FFFFFF">
      <form action="/aum/BorrowTaskList.do?flag=3" method="post">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">借阅管理&gt;&gt;任务列表</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"><br>
        ...
        <html:form action="/aum/BorrowShowForm.do" method="post">
          ...
          <tr align="center" bgcolor="#F7EED9">
            ...
            <td nowrap>是否已处理</td>
            <td nowrap>借阅者姓名</td>
            <td nowrap bgcolor="#F7EED9">借阅者单位</td>
            <td nowrap bgcolor="#F7EED9">借阅方式</td>
            <td nowrap>借阅起始日期</td>
            <td nowrap>借阅期限(天)</td>
            <td nowrap>处理环节</td>
          </tr>
