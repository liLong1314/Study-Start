...
function mySubmit(theForm){
  ...
  if(BASEtrim(name.value)=="")
    ...
    document.UtilizePersonForm.submit();
...
<html:form action="/aum/EditUtilizePerson" method="post" focus="utilizePerson.person_name">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">编辑申请人信息</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"><br>
        ...
        <html:hidden property="utilizePerson.person_id" />
          <tr bgcolor="#FFFFFF">
            <td nowrap>姓名</td>
            <td nowrap>
          ...
          <tr bgcolor="#FFFFFF">
            <td nowrap>证件类型</td>
            <td nowrap>
              <html:text property="utilizePerson.certificate_type" disabled="true" />
            </td>
            <td nowrap>证件号</td>
          ...
          <tr align="center" bgcolor="#FFFFFF">
            <td colspan="4">&nbsp;
            <input type="button" name="submit1" value="确定" onclick="mySubmit(this.form)">
            <input type="button" name="submit2" value="取消" onclick="window.location='ShowAllUtilizePerson.do'">
          </tr>
        </table>
        <br>
      </td>
