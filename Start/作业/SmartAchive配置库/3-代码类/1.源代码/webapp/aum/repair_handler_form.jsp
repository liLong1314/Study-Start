...
function mySubmit(){
  ...
  var leadConfirmIdea = document.getElementById("utilizeInfo.leadConfirmIdea");
  if (handlerCaption=="档案科审核") {
    if(!isCheck("utilizeInfo.agreeOfRegistration"))
      alert("请填写档案科审核的处理意见！");
    else
      document.UtilizeInfoForm.submit();
  }
  else if (handlerCaption=="综合科审核") {
  ...
  else if (handlerCaption=="办理补证") {
    if(BASEtrim(leadConfirmIdea.value)=="")
      alert("请填写办理信息！");
    else
      document.UtilizeInfoForm.submit();
  }
  ...
  //MM_openBrWindow('view_handler_form.jsp','查证管理','width=700,height=500')
}
...
<html:form action="/aum/RepairCommitTask" method="post" >
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">查证处理</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"><br>
        <table width="90%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr bgcolor="#FFFFFF">
            <td>档案列表明细</td>
            <td colspan="3"><a href="#" onClick="window.location='/aum/ViewUtilizeDetail.do?applyID=<bean:write  name="utilInfo" property="applyID" />&flag=2'">点击查看</a></td>
          </tr>
          <tr bgcolor="#FFFFFF">
            <td>备注</td>
            <td colspan="3">
          ...
          <tr align="center" bgcolor="#FFFFFF">
            ...
            <input type="button" name="Submit4" value="关闭" onclick="window.location='/aum/RepairTaskList.do'"></td>
          </tr>
        </table>
        <br>
      </td>
