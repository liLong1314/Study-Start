...
function mySubmit(){
  ...
  if(BASEtrim(aim.value)=="")
    ...
    alert("请输入正确的[查阅起始日期]，格式为YYYY-MM-DD。");
  else if(BASEtrim(term.value)=="")
    alert("请输入[查阅期限]！");
  else if(BASEisNotNum(term.value))
    alert("[查阅期限]应为数字，请重新输入！");
  else if (!isCheck("utilizeInfo.external"))
    alert("请选择是否为外部人员！");
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">查阅申请</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
        ...
        <table width="95%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
          <tr bgcolor="#FFFFFF">
            ...
            <td nowrap>
              ...
              <input type="button" name="button1" value="选择查阅人" onClick="window.location='/aum/ShowAllUtilizePerson.do?type=1'">
            </td>
            <td nowrap>查阅者单位</td>
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <td nowrap>
              <input type="radio" name="utilizeInfo.external" value="1"
                <logic:equal name="isSelf" value="0">checked</logic:equal>
              disabled />是
              <input type="radio" name="utilizeInfo.external" value="0"
                <logic:equal name="isSelf" value="1">checked</logic:equal>
              disabled />否
            </td>
