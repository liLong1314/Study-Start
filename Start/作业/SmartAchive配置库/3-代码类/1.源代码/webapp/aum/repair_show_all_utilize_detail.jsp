        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            <td colspan="3" bgcolor="#F7EED9">
            	...
            	<input type="button" name="Submit3" value="申请" onclick="window.location='/aum/RepairStartApplyFlow.do?applyID=<bean:write name="applyID"/>'">
            	<input type="button" name="Submit3" value="取消申请" onclick="window.location='/aum/DeleteUtilizeInfo.do?showTaskFlag=3'">
            </td>
          </tr>
        </table>
      </td>
