...
<script>
  ...
  function doFilter(filterFlag) {
    window.location.href="/aum/RepairTaskList.do?flag="+filterFlag;
  }
...
function doCombQuery(form){
  ...
  if(!BASEtrim(applyBeginTime.value)=="" && BASEisNotDate(applyBeginTime.value))
    ...
    window.location.href="/aum/RepairTaskList.do?queryFlag="+queryFlag+"&deliverBeginTime="+deliverBeginTime.value+"&deliverEndTime="+deliverEndTime.value+"&applyBeginTime="+applyBeginTime.value+"&applyEndTime="+applyEndTime.value+"&utilizer="+utilizer.value;;
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td align="center"    bgcolor="#FFFFFF">
      <form action="/aum/RepairTaskList.do?flag=3" method="post">
              ...
              <tr align="center" bgcolor="#FFFFFF">
                <td width="40%" align="center">
                  <logic:equal name="filterFlag" value="0">
                   <input type="radio" name="unhandled" value="3" >未处理
                   <input type="radio" name="handled" value="4" >已处理
                   <input type="radio" name="both" value="5" >所有
                  </logic:equal>
                </td>
                <td width="50%" align="center">查询时间：
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">查证管理&gt;&gt;任务列表</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
    ...
    <tr>
      ...
      <td align="center" bgcolor="#FFFFFF"><br>
        ...
        <html:form action="/aum/RepairShowForm.do" method="post">
          ...
          <tr align="center">
            ...
            <td bgcolor="#f6f6f6">
              ...
              <logic:equal name="task" property="utilizeStatus" value="CONFIRMEDBYCO">
                <font color="green">
              ...
              <logic:notEqual name="task" property="utilizeStatus" value="CONFIRMEDBYCO">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <input name="Submit3" type="button" value="处理" onclick="mySubmit(1)">
