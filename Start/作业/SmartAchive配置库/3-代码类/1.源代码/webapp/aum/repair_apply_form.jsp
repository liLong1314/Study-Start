      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">查证申请</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
        ...
        <table width="95%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
          <tr bgcolor="#FFFFFF">
            ...
            <td nowrap>
              ...
              <input type="button" name="button1" value="选择借阅人" onClick="window.location='/aum/ShowAllUtilizePerson.do?type=3'">
            </td>
            <td nowrap>查证者单位</td>
          ...
          <tr bgcolor="#FFFFFF">
            <td nowrap>查证起始日期(YYYY-MM-DD)</td>
