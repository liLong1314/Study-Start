...
function validateForm(theform){
	...
	var info_feedback_content = document.getElementById("publishInfo.info_feedback_content");
		...
		return BASEalert("请输入正确的[回复内容]！",info_feedback_content);
        return true;
}
</script>
</head>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">回复用户反馈</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
	...
	<span id=err style="display:none"><bean:write name="PublishInfoForm" property="msgError"/></span>
        ...
        <table width="95%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
          <tr bgcolor="#FFFFFF">
            <td nowrap>反馈标题<font color=red>*</font></td>
		...
		<logic:empty name="publishInfoAccessoryList">无</logic:empty>
          ...
          <tr bgcolor="#FFFFFF">
            <td nowrap>回复内容<font color=red>*</font></td>
		...
		<input type="button" name="Submit3" value="返回" onclick="window.location.href='/pub/queryFeedbackList.do?page='">
          </tr>
        </table>
      </td>
