...
function validateForm(theform){
	...
	var info_title = document.getElementById("publishInfo.info_title");
		...
		return BASEalert("请输入正确的[反馈标题]！",info_title);
        return true;
}
</script>
</head>
...
<html:form action="/pub/addPublishInfo" enctype="multipart/form-data">
  ...
  <html:hidden property="publishInfo.info_status" value="1"/>
  <html:hidden property="publishInfo.info_type" value="BUG"/>
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">新增用户反馈信息</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
