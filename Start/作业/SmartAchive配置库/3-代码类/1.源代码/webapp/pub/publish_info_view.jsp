      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">查看发布信息</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
	...
	<span id=err style="display:none"><bean:write name="PublishInfoForm" property="msgError"/></span>
		...
		<html:optionsCollection property="info_typeOptions"/>
          ...
          <tr bgcolor="#FFFFFF">
            <td nowrap>发布标题</td>
            <td colspan="3" >
		<bean:write name="PublishInfoForm" property="publishInfo.info_title"/>
            </td>
          </tr>
          <tr bgcolor="#FFFFFF">
            <td nowrap>发布内容</td>
            <td colspan="3" >
		<bean:write name="PublishInfoForm" property="publishInfo.info_content"/>
            </td>
          </tr>
          <tr bgcolor="#FFFFFF">
            <td nowrap>附件</td>
		...
		<logic:empty name="publishInfoAccessoryList">无</logic:empty>
          ...
          <tr bgcolor="#FFFFFF">
            <td nowrap>发布人员</td>
            <td colspan="3" >
		<bean:write name="PublishInfoForm" property="publishInfo.info_publish_person"/>
            </td>
          </tr>
          <tr bgcolor="#FFFFFF">
            <td nowrap>发布时间</td>
            <td colspan="3" >
		<bean:write name="PublishInfoForm" property="publishInfo.info_publish_datetime"/>
            </td>
          </tr>
          <tr bgcolor="#FFFFFF">
