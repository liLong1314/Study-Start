...
<html:form action="/pub/updatePublishInfo" method="post">
  <html:hidden property="operName" value="EDIT"/>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">维护发布信息</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
	...
	<span id=err style="display:none"><bean:write name="PublishInfoForm" property="msgError"/></span>
		...
		<input type="button" name="Submit3" value="返回" onclick="window.location.href='/pub/queryPublishInfoList.do?ACT=EDT&page='">
          </tr>
        </table>
      </td>
