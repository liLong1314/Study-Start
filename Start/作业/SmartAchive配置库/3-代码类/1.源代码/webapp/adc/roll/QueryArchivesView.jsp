...
<html:form action="/adc/queryArchivesView" method="post" >
<html:hidden property="functionName"/>
<html:hidden property="archives.AARCHIVES_STATUS" value="0" />
			...
			<!--注释BY ZXQ：只显示未归档的档案
			  <td nowrap>档案状态：
				...
				<html:radio property="archives.AARCHIVES_STATUS" value="1" />已归档
                  ...
                  <td align="center" nowrap colspan=2> <input type="submit" name="btnQry" value="查询" onClick="setFunctionName('QueryAllArchives')"></td>
                </tr>
              </table>
              </td>
            </tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td align="center" bgcolor="#FFFFFF"><br>
        ...
        <tr align="center">
          <td width="10" align="center"><input type="checkbox" name="selectID" value="<bean:write name='item' property='AARCHIVES_ID'/>"></td>
		  <td width="100%" align="center">
	    	<table align="center" width="100%" border="0" cellpadding="2" cellspacing="1">
			<tr align="center"  bgcolor="#f6f6f6" style='cursor:hand' title="查看档案详细信息"
	        	onMouseover="this.style.backgroundColor='#dff1ff'"
	        	onMouseOut="this.style.backgroundColor='#f6f6f6'"
	        	onclick="window.location='viewArchivesFilesList.do?ARCHIVES_ID=<bean:write name='item' property='AARCHIVES_ID' />'">
	            <td width="150"><bean:write name="item" property="AARCHIVES_NUM" /></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="center" bgcolor="#F7EED9"> <p>
              <input type="Submit" name="btn91" value="归  档" onclick="setFunctionName('Roll')">
              <!--<input type="Submit" name="btn92" value="未归档" onclick="setFunctionName('UnRoll')">-->
              <input type="button" name="btnPrint" value="打印" onclick="window.print()">
            </p></td>
        </tr>
      </table>
