...
function mySubmit() {
	...
	if(window.opener) {
		window.opener.document.CheckArchivesPageViewForm.functionName.value = "UpdateFileID";
    ...
    <td width="94%" height="10" background="../../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
        <tr align="center"> 
          ...
          <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#00A8CC">
              <tr> 
                <td align="center" bgcolor="#E4F2FA" class="tishi">修改所属文件</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
  ...
  <tr> 
    ...
    <td align="center" valign="middle" bgcolor="#FFFFFF"><br>
      <table align="center">
        <tr> 
          <td> 
          	<bean:define id="aa" name="CheckArchivesPageViewForm" property="list_ArchivesFiles"/> 
