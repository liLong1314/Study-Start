...
<html:form action="/adc/ScanArchivesView" method="post" >
...
<!--          <td>序号</td> -->
        ...
        <tr align="center" bgcolor="#f6f6f6" style='cursor:hand' 
        	...
        	onclick="window.location='../adc/ScanFileView.do?archives_id=<bean:write name='archivesListItem' property='AARCHIVES_ID' />'">
