...
function doClick(projId,upPhaseId,phaseId){
        ...
        window.location.href="addArchivesFile.do"
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center" bgcolor="#F7EED9">
              ...
              <input type="button" name="Submit6" value="打印卷内目录" onClick="window.location='/adc/print_roll_catalog_yewu.jsp?archives_id=<bean:write name="ArchivesFileForm" property="archives.AARCHIVES_ID"/>'">
              <input type="button" name="Submit8" value="打印案卷封面" onClick="window.location='/adc/print_roll_face.jsp?archives_id=<bean:write name="ArchivesFileForm" property="archives.AARCHIVES_ID"/>'">
              <input type="button" name="Submit9" value="打印卷内备考表" onClick="window.location='/adc/print_roll_beikao_yewu.jsp?archives_id=<bean:write name="ArchivesFileForm" property="archives.AARCHIVES_ID"/>'">
