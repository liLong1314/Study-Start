...
<html:form action="/adc/queryArchivesPieceList" method="post" >
  ...
  <html:hidden property="archives.AROLL_MODE" value="2"/>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" bgcolor="#F7EED9"> <p>
              ...
              <input type="button" name="Submit4" value="返回" onclick="window.location='/adc/archives_piece_input.jsp'">
            </p></td>
        </tr>
      </table>
