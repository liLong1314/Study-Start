...
<script>
	...
	function doQuery(){
		window.location="archives_piece_query_for_edit.jsp";
	}
</script>
</head>
<body class="bg-page01">
<html:form action="/adc/insertPiece.do" method="post">
      ...
      <td align="center" bgcolor="#FFFFFF"><table width="95%" border="1">
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                <tr bgcolor="#FFFFFF">
                  ...
                  <td nowrap><html:text property="archives.APIECE_NUM" size="10"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td nowrap>机构或问题</td>
            ...
            <html:optionsCollection property="ASTORE_TERMOptions"/>
                ...
                <tr bgcolor="#FFFFFF">
                  ...
                  <td colspan="5" nowrap><html:text property="archives.AARCHIVES_NUM" size="20"/></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="474" colspan="6" nowrap>
