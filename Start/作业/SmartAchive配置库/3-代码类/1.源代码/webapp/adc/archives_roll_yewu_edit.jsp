      ...
      <td align="center" bgcolor="#FFFFFF"><table width="95%" border="1">
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                <tr bgcolor="#FFFFFF">
                  ...
                  <td nowrap colspan=3><html:text property="archives.AARCHIVES_NUM" size="35" readonly="true"/></td>
                  <!--
                  <td nowrap>案卷号<font color=red>*</font></td>
                  <td nowrap><html:text property="archives.AROLL_NUM" size="4" readonly="true"/></td>-->
