...
<html:form action="/rcv/updateSettleArchivesFile.do" method="post">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="849" align="left" bgcolor="#FFFFFF"> 您现在的位置： &gt;&gt; 电子文件 &gt;&gt; 文件整理(文书类)</td>
      ...
      <td width="100%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#0293CA">
                <tr>
                  <td align="center" bgcolor="#E4F7FA" class="tishi">文件著录信息</td>
                </tr>
            </table></td>
          </tr>
      </table></td>
...
<td align="center" bgcolor="#FFFFFF">          <table width="95%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
          <tr bgcolor="#FFFFFF">
		...
		<input type="reset" name="Submit3" value="取消" onclick="window.location='/rcv/querySettleArchivesFileList.do'"></td>
          </tr>
        </table>
