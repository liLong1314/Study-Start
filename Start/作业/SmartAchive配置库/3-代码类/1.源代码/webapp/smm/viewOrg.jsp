      ...
      <td width="100%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr nowrap  align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#0293CA">
                <tr nowrap >
                  <td align="center" bgcolor="#E4F7FA" class="tishi">组织信息</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
      ...
      <td align="center" bgcolor="#FFFFFF">
		...
		<logic:iterate id="org" name="allOrgList" >
          <tr nowrap  align="center">
            ...
            <td bgcolor="#f6f6f6"><a href="/smm/viewOrg.do?orgid=<bean:write name="org" property="id" />" style='cursor:hand' onMouseover="this.style.backgroundColor='#dff1ff'" onMouseOut="this.style.backgroundColor='#f6f6f6'"><bean:write name="org" property="name" /></a></td>
            <td bgcolor="#f6f6f6"><bean:write name="org" property="superiorOrg" /></td>
          </tr>
		</logic:iterate>
		</logic:present>
		</form>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr nowrap >
		    ...
		    <form name="delform" method="post" action="../../smm/deleteOrg.do" onSubmit="javascript:delConfirm(allOrgList,this.ids)">
            <td width="13%" align="center" bgcolor="#F7EED9">
              <input type="hidden" name="ids">
              <input type="submit" name="delete" value="删除选中" alt="删除选中">
			</td>
            </form>
            <td width="65%" bgcolor="#F7EED9"><input type="button" name="addUser" value="新增用户" onClick="javascript:location='newOrg.jsp'"></td>
