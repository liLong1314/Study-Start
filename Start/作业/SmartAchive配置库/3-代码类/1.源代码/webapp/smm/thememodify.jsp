      ...
      <td width="100%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#0293CA">
                <tr>
                  <td align="center" bgcolor="#E4F7FA" class="tishi">主题词修改</td>
                </tr>
              </table></td>
          </tr>
        </table></td>
        ...
        <table width="100%" border="1">
          <tr>
            <td height="112"> <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
              <html:form action="/smm/thememodify.do" method="post">
              <html:hidden name="themeForm" property="themeInfo.themeId"/>
                <tr bgcolor="#FFFFFF">
