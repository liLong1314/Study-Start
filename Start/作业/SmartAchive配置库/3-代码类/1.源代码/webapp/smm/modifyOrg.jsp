...
<html:form action="/smm/modifyOrg.do" method="POST">
<html:hidden name="orgForm" property="org.id"/>
      ...
      <td width="94%" background="../image/2_table_c_t.gif"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr nowrap align="center">
            ...
            <td width="212"><table width="200" border="0" cellpadding="2" cellspacing="1" bgcolor="#99CC00">
                <tr nowrap>
                  <td align="center" bgcolor="#F2F9E6" class="tishi">组织修改</td>
                </tr>
              </table>
            </td>
          </tr>
	  ...
	  <bean:write name="orgForm" property="operResults"/>
        <table width="95%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
          <tr nowrap bgcolor="#FFFFFF">
	        <td width="28%">组织名称</td>
	        <td colspan="3"><html:text size="12" name="orgForm" property="org.name"/></td>
          </tr>
          <tr nowrap bgcolor="#FFFFFF">
	        <td>描述信息</td>
	    <td colspan="3"><html:text size="12" name="orgForm" property="org.desc"/></td>
          </tr>
          <tr nowrap bgcolor="#FFFFFF">
	    <td>上级组织</td>
	    <td colspan="3">
		  <html:text size="12" name="orgForm" property="org.superiorOrgName" readonly="true"/>
