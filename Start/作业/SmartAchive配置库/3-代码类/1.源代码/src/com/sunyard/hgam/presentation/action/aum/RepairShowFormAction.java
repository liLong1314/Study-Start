...
public class RepairShowFormAction
    extends BaseAction {
  ...
  public ActionForward doPerform(ActionMapping mapping, ActionForm form,
    ...
    if (flag.equals("HANDLER")) {
      ...
      try {
        ...
        if (status.equals("UNCONFIRMEDBYAR") || status.equals("UNCONFIRMEDBYCO")) {
          btnCaption = "申请";
        }
        ...
        else if (status.equals("CONFIRMEDBYAR")) {
          btnCaption = "综合科审核";
        }
        else if (status.equals("CONFIRMEDBYCO")) {
          btnCaption = "办理补证";
        }
        else if (status.equals("TRANSACTED")) {
          btnCaption = "收费";
        }
        ...
        request.getSession().setAttribute("flowDefID","3");
    ...
    //跟踪流程实例
      ...
      try {
        ...
        for (int i = 0; i < taskList.size(); i++) {
          ...
          if (taskName.equals("补证申请") || taskName.equals("结束节点"))
            continue;
