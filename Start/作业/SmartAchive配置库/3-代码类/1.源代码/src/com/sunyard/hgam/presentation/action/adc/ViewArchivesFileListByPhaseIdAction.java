...
public class ViewArchivesFileListByPhaseIdAction extends BaseAction {
  public ActionForward doPerform(ActionMapping mapping,
    ...
    try {
      ...
      if (archives_id == null || archives_id.equalsIgnoreCase("")) {
        archives_id = (String) request.getSession().getAttribute(
            "ARCHIVES_ID");
      }
      ...
      Archives archives = archivesDao.getArchivesByArchivesID(Integer.
          parseInt(archives_id));
      //修订：郑先全，20040205
      //设置：立档单位 密级 保管期限
      ...
      if (archivesFilesList == null || page == null) {
        ...
        //获取档案文件列表
        archivesFilesList = archivesFileDao.queryArchivesFileByPhaseID(archivesFile);
        //设置SESSION
